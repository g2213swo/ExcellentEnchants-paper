...
public class Lang extends EngineLang {
    ...
    public static final LangKey COMMAND_BOOK_DONE = new LangKey("Command.Book.Done", "Given <gold>%enchant%</gold> enchanted book to <gold>%player%</gold>.");
    ...
    public static final LangKey COMMAND_TIER_BOOK_DONE = new LangKey("Command.TierBook.Done", "Given <gold>%tier%</gold> enchanted book to <gold>%player%</gold>.");

    public static final LangKey ERROR_NO_ENCHANT = new LangKey("Error.NoEnchant", "<red>No such enchant.");
