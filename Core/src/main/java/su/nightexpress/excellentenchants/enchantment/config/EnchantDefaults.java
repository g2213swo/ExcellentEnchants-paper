...
public class EnchantDefaults {
    ...
    public @NotNull EnchantScaler getLevelByEnchantCost() {
    ...
    public @NotNull EnchantScaler getAnvilMergeCost() {
    ...
    public @NotNull Map<ObtainType, Double> getObtainChance() {
        return obtainChance;
    }

    public @NotNull Map<ObtainType, int[]> getObtainLevelCap() {
    ...
    public @NotNull EnchantScaler getChargesMax() {
        return chargesMax;
    }
    ...
    public @NotNull EnchantScaler getChargesConsumeAmount() {
    ...
    public @NotNull EnchantScaler getChargesRechargeAmount() {
