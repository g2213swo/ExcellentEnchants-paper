...
public class EnchantRegistry {
    ...
    public static @Nullable ExcellentEnchant getById(@NotNull String id) {
        return getByKey(EnchantUtils.createKey(id));
    }

    public static @Nullable ExcellentEnchant getByKey(@NotNull NamespacedKey key) {
        return REGISTRY_MAP.get(key);
    }

    public static @NotNull Collection<ExcellentEnchant> getRegistered() {
